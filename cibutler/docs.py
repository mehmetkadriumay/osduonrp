    ...
    if isinstance(obj, Group):
        ...
        if commands:
            ...
            for command in commands:
                ...
                assert command_obj
                if command_obj.hidden and hide_hidden:
                    continue
...
@cli.command(help="Generate markdown version of usage documentation")
def generate(
    ctx: typer.Context,
...
@cli.command(help="Open published docs")
def open(ctx: typer.Context):
    webbrowser.open("https://osdu.pages.opengroup.org/ui/cibutler/")
